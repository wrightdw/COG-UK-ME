...
database <- read_rds("2021-01-31/database.rds")
consortium_uk <- read_rds("2021-01-31/consortium_uk.rds")
mutations_uk <- read_rds("2021-01-31/mutations_uk.rds")
mutation_reference_counts <- read_rds("2021-01-31/mutation_reference_counts.rds") # precomputed mutation counts 

mutations_s_uk <- mutations_uk %>% filter(gene == "S")

dataset_date <- ymd("2021-01-31") #TODO derive from filename
