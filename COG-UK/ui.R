    ...
    sidebar = dashboardSidebar(
        sidebarMenu(
            ...
            menuItem(
                ...
                icon = icon("viruses"),
                startExpanded = TRUE,
                menuSubItem("Variants of Interest", tabName = "vui_voc", selected = TRUE),
                menuSubItem("Spike Mutations", tabName = "report")
            ),
        ...
        tabItems(
            tabItem(tabName = "about",
                    fluidRow(
                        ...
                        tags$ol(
                            tags$li("the designated global variants of concern and their structural context"),
            ...
            tabItem(tabName = "report",
                        ...
                        tabsetPanel(
                            ...
                            tabPanel("Table 1",
                                     ...
                                     box(title = "Mutational Analysis", closable = FALSE, width = 12,
                                         status = "info", collapsible = FALSE, icon = icon("table"),   
