...
params: 
  ...
  dataset_date:     "2022-02-01" # Used if latest == FALSE. if empty, defaults to today's date, otherwise enter date string
...
deletions_mapping <- 
  ...
  # rename(variant = del_id, 
  #        position = del_start) #%>% 
  # select(-c(del_end, del_subst, ref_start, length, position))
