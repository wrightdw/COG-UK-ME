...
params: 
  mutations_csv:  "cog_global_2021-02-16_mutations.csv"
  global_csv:     "cog_global_2021-02-16_public.csv"
  consortium_csv: "cog_global_2021-02-16_consortium.csv"
...
variants_uk <- 
  mutations_s_uk %>% 
  group_by(variant) %>% 
  summarise(UK = n(), earliest = min(sample_date))
