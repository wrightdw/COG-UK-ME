...
consortium_uk %>% filter(n501y == "Y" & del_21765_6 == "del")  %>% count(lineage) %>% arrange(desc(n))
```
```{r}

consortium_uk %>% filter(sample_date >= params$sample_date_28 & n501y == "Y" & del_21765_6 == "del")  %>% count(lineage) %>% arrange(desc(n))
```
```{r}

consortium_uk %>% filter(n439k == "K" & del_21765_6 == "del")  %>% count(lineage) %>% arrange(desc(n))
```
```{r}

consortium_uk %>% filter(sample_date >= params$sample_date_28 & n439k == "K" & del_21765_6 == "del")  %>% count(lineage) %>% arrange(desc(n))
```
```{r}
