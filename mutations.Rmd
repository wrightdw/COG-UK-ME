...
epitopes_mutations_gff <- 
  ...
  clean_names %>% 
  filter(gene == "S" & num_seqs_uk > 0) %>% 
  select(start_position, epitope, position, mutation, num_seqs_uk, num_seqs_uk_28_days) %>% 
  distinct %>% 
  ...
  mutate(attributes = paste0("Parent=", start_position, epitope, ";", 
                             "Name=", attributes, ";", 
                             "num_seqs_uk=", num_seqs_uk, ";", 
                             "num_seqs_uk_28_days=", num_seqs_uk_28_days), .keep = "unused") 
