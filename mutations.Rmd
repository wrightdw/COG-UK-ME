...
params: 
  ...
  dataset_date:     "2022-01-25" # Used if latest == FALSE. if empty, defaults to today's date, otherwise enter date string
...
dodgy_omicron <- 
  consortium_uk %>% 
  filter(lineage == "BA.1" & sample_date < "2021-11-20")
...
vui_voc <-
  ...
  mutate(across(c(lineage, lineage_display), as_factor)) 
