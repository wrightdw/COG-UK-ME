...
consortium_uk_parent <-
  bind_rows(
    ...
    consortium_uk %>%
      ...
      mutate(lineage = gsub(sublineage_regex_gsub("BA.2"), "BA.2", lineage)) %>%  # convert BA.2.x to BA.2
      mutate(lineage = gsub(sublineage_regex_gsub("BA.4"), "BA.4", lineage)) %>%  # convert BA.4.x to BA.4
      mutate(lineage = gsub(sublineage_regex_gsub("BA.5"), "BA.5", lineage)) %>%  # convert BA.5.x to BA.5
